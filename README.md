<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/hero.png?raw=true" alt="Pi Monorepo">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/happyshittake/oh-my-pi/blob/main/packages/coding-agent/CHANGELOG.md"><img src="https://img.shields.io/badge/changelog-keep-E05735?style=flat&colorA=222222" alt="Changelog"></a>
  <a href="https://github.com/happyshittake/oh-my-pi/actions"><img src="https://img.shields.io/github/actions/workflow/status/happyshittake/oh-my-pi/ci.yml?style=flat&colorA=222222&colorB=3FB950" alt="CI"></a>
  <a href="https://github.com/happyshittake/oh-my-pi/blob/main/LICENSE"><img src="https://img.shields.io/github/license/happyshittake/oh-my-pi?style=flat&colorA=222222&colorB=58A6FF" alt="License"></a>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/python.webp?raw=true" alt="python">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/lspv.webp?raw=true" alt="lsp">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/ttsr.webp?raw=true" alt="ttsr">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/review.webp?raw=true" alt="review">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/task.webp?raw=true" alt="task">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/models.webp?raw=true" alt="models">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/ask.webp?raw=true" alt="ask">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/slash.webp?raw=true" alt="slash">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/discovery.webp?raw=true" alt="discovery">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/perplexity.webp?raw=true" alt="perplexity">
</p>
...
<p align="center">
  <img src="https://github.com/happyshittake/oh-my-pi/blob/main/assets/arxiv.webp?raw=true" alt="arxiv">
</p>
...
```bash
curl -fsSL https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.sh | sh
```

**Windows (PowerShell):**

```powershell
irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1 | iex
```
...
```bash
# Source install (Bun)
curl -fsSL https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.sh | sh -s -- --source

# Install release tag via binary
curl -fsSL https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.sh | sh -s -- --binary --ref v3.20.1

# Install branch/commit via source
curl -fsSL https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.sh | sh -s -- --source --ref main
```

```powershell
# Install release tag via binary
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1))) -Binary -Ref v3.20.1
# Install branch/commit via source
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1))) -Source -Ref main
```

### Via [mise](https://mise.jdx.dev)

```bash
mise use -g github:happyshittake/oh-my-pi
```

### Manual download

Download binaries directly from [GitHub Releases](https://github.com/happyshittake/oh-my-pi/releases/latest).
