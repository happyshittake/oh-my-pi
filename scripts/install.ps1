...
# Usage: irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1 | iex
#
# Or with options:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1))) -Source
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1))) -Binary
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/happyshittake/oh-my-pi/main/scripts/install.ps1))) -Source -Ref v3.20.1
